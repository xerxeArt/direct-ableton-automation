...
export type { DeviceSpec, ExternalInstrument, TrackSpec, SectionSpec, LocatorSpec, SongStructure, SongJSON, Clip, InstrumentSpec as Instrument } from './schemas/song.js';
...
// Locator alias
export type { LocatorSpec as Locator } from './schemas/song.js';
